...
- Se documenta el riesgo legal de licenciamiento del pipeline VTON en `.speckit/.../constitution.md` §7 (Riesgos Conocidos a Vigilar) y en `docs/context/base-plan.md` §8 (Matriz de Riesgos), con tres rutas de resolución explícitas.
...
- Artefactos afectados: `openspec/specs/02-wardrobe-flow.md`, `03-outfits-flow.md`, `04-vton-flow.md`, `06-landing-and-auth-flow.md`, nuevo `08-api-contract-gaps.md`.
- Documentos de gobierno: `.speckit/.../constitution.md`, `docs/context/base-plan.md`.
