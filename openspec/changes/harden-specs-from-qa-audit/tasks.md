...
- [x] 2.2 Añadir la misma entrada a `docs/context/base-plan.md` §8 "Matriz de Riesgos y Mitigación", como fila nueva en el mismo formato tabular — verificado que la tabla mantiene su formato Markdown válido
...
- [x] 7.2 `docs/context/frontend-plan.md` §6 actualizado para referenciar `openspec/specs/08-api-contract-gaps.md` en vez de solo la prosa de gap original
